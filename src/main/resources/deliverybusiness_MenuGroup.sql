...
CREATE TABLE `MenuGroup` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_MenuGroup_menu1_idx` (`menu_id`),
  CONSTRAINT `fk_MenuGroup_menu1` FOREIGN KEY (`menu_id`) REFERENCES `menu` (`ID`)
...
INSERT INTO `MenuGroup` VALUES (1,'Breakfast',1),(2,'Lunch',1),(3,'Dinner',1);
